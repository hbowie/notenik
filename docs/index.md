...
<div id="toc">
  <ul>
    ...
    <li>
      ...
      <ul>
        <li>
          <a href="#importexport-in-notenik-format">Import/Export in Notenik Format</a>
        </li>
        <li>
          <a href="#export-to-opml">Export to OPML</a>
        </li>
        <li>
          <a href="#importexport-in-tabdelimited-format">Import/Export in Tab-Delimited Format</a>
        </li>
        <li>
          <a href="#export-to-tabdelimited-for-ms-links">Export to Tab-Delimited for MS Links</a>
        </li>
        <li>
          <a href="#importexport-in-xml-format">Import/Export in XML Format</a>
        </li>
      </ul>
...
Tags are stored internally within a Note, so they sync easily to all of your devices along with the rest of the contents of each Note.
...
<h2 id="importexport-your-notes">Import/Export Your Notes</h2>
...
<h3 id="importexport-in-notenik-format">Import/Export in Notenik Format</h3>
...
<h3 id="importexport-in-tabdelimited-format">Import/Export in Tab-Delimited Format</h3>
...
<h3 id="importexport-in-xml-format">Import/Export in XML Format</h3>
